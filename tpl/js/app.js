...
function pesOriginal(tipo) {
	...
	if(tipo == 'main') {
		$(".appOriginal #dados").attr("placeholder", "Escolha uma opção para iniciar..");
		$(".appOriginal #tipo").val("cpf");
		$(".appOriginal #dados").val("");
		$(".appOriginal #bntOrigOk").html("Escolha uma opção <span class=\"caret\"></span>");
		
		$('#bntOrigOk').addClass('activ');
		$('.dropdown-menu').addClass(' activmen');
		$("#bntvai").hide();
		$("#dados").hide();
	}else if(tipo == 'cpf') {
		$('#bntOrigOk').removeClass('activ');
		$('.dropdown-menu').removeClass(' activmen');
		...
		<div class="form-group">
		<span>Bairro:</span>
		<input name="cep" id="cep" placeholder="Bairro" min="0" maxlength="" class="form-control" value="" type="text">
		</div>
		</div>
		...
		<button type="button" class=" btn btn-success" onclick="PesquisarZip();">
		<span>Pesquisar</span>
		</button>
		...
		$(".appOriginal #dados").attr("placeholder", "Digite o CEP");
		$(".appOriginal #tipo").val("cep");
		$(".appOriginal #dados").val("");
		$(".appOriginal #bntOrigOk").html("CEP <span class=\"caret\"></span>");
		$("#bntvai").show();
		$("#dados").show();
		...
		$(".appOriginal #dados").attr("placeholder", "Digite o Email");
		$(".appOriginal #tipo").val("email");
		$(".appOriginal #dados").val("");
		$(".appOriginal #bntOrigOk").html("Email <span class=\"caret\"></span>");
		$("#bntvai").show();
		$("#dados").show();
		...
		$(".appOriginal #dados").attr("placeholder", "Digite o numero do beneficio");
		$(".appOriginal #tipo").val("inss");
		$(".appOriginal #dados").val("");
		$(".appOriginal #bntOrigOk").html("INSS <span class=\"caret\"></span>");
		$("#bntvai").show();
		$("#dados").show();
...
function load() {
	...
	<button title="Clique aqui!" alt="clique aqui!" type="button" id="bntOrigOk" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
	&nbsp;&nbsp;&nbsp;&nbsp;Escolha uma opção&nbsp;&nbsp;&nbsp;<span class="caret"></span>
	</button>
	<ul class="dropdown-menu">
	<li><a href="javascript:void(0)" onclick="pesOriginal('cpf');">Pesquisar CPF</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('cnpj');">Pesquisar CNPJ</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('telefone');">Pesquisar Telefone</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('endereco');">Pesquisar Endereco</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('cep');">Pesquisar Cep</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('email');">Pesquisar E-mail</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('inss');">Pesquisar NB/INSS</a></li>
	</div>
	...
	<span class="input-group-btn" id="bntvai">
	<button class="btn btn-success" type="button" onclick="PesquisarZip();">Pesquisar</button>
	</span>
	</div>
	`;
...
function main() {
	...
	<div class="input-group-btn">
	<input type="hidden" name="tipo" id="tipo" value="cpf">
	<button type="button" id="bntOrigOk" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
	CPF <span class="caret"></span>
	</button>
	<ul class="dropdown-menu">
	<li><a href="javascript:void(0)" onclick="pesOriginal('main');">Escolha uma opção</a></li>
	...
	<li><a href="javascript:void(0)" onclick="pesOriginal('cep');">Cep</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('email');">Email</a></li>
	<li><a href="javascript:void(0)" onclick="pesOriginal('inss');">INSS</a></li>
	</div>
...
function PesquisarZip() {
	...
	if(data.length < 1) {
		...
		.done(function(res) {
			  if(res === 'false'){
			  $("#loading").hide();
			  $('#reserror').html("<center><strong>Nada encontrado, refine sua busca e tente novamente.</strong></center>");
			  $('#reserror').show();
			  return;
			  }
